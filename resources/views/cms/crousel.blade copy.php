...
@section('main')
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Sliding Images </h1>
            <ol class="breadcrumb">
          ...
          @foreach ($header as $head)
                <div class="modal fade" id="logoInput" tabindex="-1" role="dialog"
...
<!-- pop-up models -->
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle btn btn-primary btn-sm" data-toggle="modal" data-target="#crausalAdd" id="#crausalAdd" aria-haspopup="true" aria-expanded="false" style="color: #fff">
                      Add Slider
                    </a>
                  </div>
                </div>
            ...
            <!-- new crausal pop-up -->
                      <div class="modal fade" id="crausalAdd" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <div class="card mb-4">
                                <div class="card-body">
                                  <form action="/addSlider" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                      <input type="file" class="form-control" name="slider" id="file" placeholder="Choose file">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label for="name"> Image subtitle</label>
                                      <input type="text" class="form-control" name="sub" placeholder="subtitle" required>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="card-body">
                  ...
                  <div class="info-body">
                    ...
                    style="background: none">
                      ...
                      <a href=""></a>
                        <a class=" btn btn-danger btn-sm" href="{{ url('/deleteSlider/'.$sld->id) }}" role="button">Delete Slider</a>
                    </div>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="small text-gray-500">
                      <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="img" id="file" placeholder="Choose file">
                      </div>
                      <div class="col-sm-10" >
                        <button type="submit" class="btn btn-primary">Update</button>
                      </div>
                  ...
                  <div class="mb-3">
                    <form action="/updateCrTitle" method="POST" enctype="multipart/form-data">
                      @csrf
                    <div class="small text-gray-500">
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                  ...
                  <div class="mb-3">
                    <form action="/updateCrDescription" method="POST" enctype="multipart/form-data">
                      @csrf
                    <div class="small text-gray-500">
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
